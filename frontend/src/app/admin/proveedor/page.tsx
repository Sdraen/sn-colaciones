...
import type { MenuWeekDto, NotificationDto, OrdersReportDto, ProviderOperationsDto } from "@/lib/api/contracts";
...
export default async function ProviderAdminPage() {
  ...
  const [operations, nextMenu, report, notifications] = await Promise.all([
  ...
  return <ProviderOperationsClient initialOperations={operations} initialNextMenu={nextMenu} nextStartsOn={nextStartsOn} initialReport={report} notifications={notifications} />;
}
